...
This directory contains the backend API for VertexMemory, built with FastAPI and SQLAlchemy. This also runs the Google Cloud Vertex AI MCP Server that you can use with MCP clients to remember things.

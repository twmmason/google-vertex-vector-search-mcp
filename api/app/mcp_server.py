...
# Qdrant client import removed after migration to Vertex AI

# Load environment variables
load_dotenv()

# Initialize MCP and memory client
mcp = FastMCP("vertex-vector-mcp-server")
    ...
    try:
        ...
        try:
            ...
            if not app.is_active:
                return f"Error: App {app.name} is currently paused on VertexMemory. Cannot create new memories."

            response = memory_client.add(text,
                                         user_id=uid,
                                         metadata={
                                            "source_app": "vertexmemory",
...
async def search_memory(query: str) -> str:
    ...
    try:
        ...
        try:
            ...
            # Accessible IDs are already enforced at the SQL level; no Qdrant filter needed.
...
def setup_mcp_server(app: FastAPI):
    ...
    mcp._mcp_server.name = "vertex-vector-mcp-server"
